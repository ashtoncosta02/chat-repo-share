...
const STORAGE_KEY = "af-help-chat-messages";

const WELCOME: ChatMessage = {
  role: "assistant",
  content:
    "Hi! I'm your Ask Janice help assistant. Ask me anything about using the app — creating agents, phone numbers, the chat widget, or troubleshooting.",
};
...
export function OwnerChatWidget() {
  ...
  async function ask(text: string) {
    ...
    try {
      ...
      if (!token) {
        setError("Please sign in to use the help assistant.");
        setSending(false);
        return;
      }
